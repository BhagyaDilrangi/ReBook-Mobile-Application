...
public class BuyerNotesFilter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_notes_donations_filter.setOnClickListener(view -> {
            startActivity(new Intent(BuyerNotesFilter.this, BuyerNotesDonate.class));
        });

        btn_notes_sales_filter.setOnClickListener(view -> {
            startActivity(new Intent(BuyerNotesFilter.this, BuyerNotesSales.class));
        });
        btn_notes_borow_filter.setOnClickListener(view -> {
            startActivity(new Intent(BuyerNotesFilter.this, BuyerLectureNotes.class));
        });
    }
}