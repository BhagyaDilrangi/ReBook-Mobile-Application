...
public class BuyerCalcuator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerViewCalcBorrow);
        searchView = findViewById(R.id.searchCalcBorrow);
        ...
        mDatabase.orderByChild("type").equalTo("Borrow")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(BuyerCalcuator.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
