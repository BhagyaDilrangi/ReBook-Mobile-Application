...
public class BuyerCalculatarSales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerViewCalcSales);
        searchView = findViewById(R.id.searchCalcSales);
        ...
        mDatabase.orderByChild("type").equalTo("Sale")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(BuyerCalculatarSales.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
