...
public class BuyerNotesSales extends AppCompatActivity {

    private RecyclerView recyclerView;
    private ListingAdapter adapter;
    private List<Material> notesList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerViewNotesSales);
        searchView = findViewById(R.id.searchNotesSales);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot data : snapshot.getChildren()) {
                            ...
                            // Assuming notes are a specific category or we just filter by type "Sale" for this screen
                            if (material != null && "Available".equals(material.getStatus())) {
                                notesList.add(material);
                            }
                        }
                        filter(""); 
                    }
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(BuyerNotesSales.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
