...
public class BuyerLectureNotes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerViewNotesBorrow);
        searchView = findViewById(R.id.searchNotesBorrow);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot data : snapshot.getChildren()) {
                            ...
                            if (material != null && "Notes".equals(material.getCategory()) && "Available".equals(material.getStatus())) {
                                list.add(material);
                            }
                        }
                        filter(""); 
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(BuyerLectureNotes.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
