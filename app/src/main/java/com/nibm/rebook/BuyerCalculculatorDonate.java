...
public class BuyerCalculculatorDonate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_buyer_calculculator_donate);

        if (getSupportActionBar() != null) {
            getSupportActionBar().hide();
        }

        recyclerView = findViewById(R.id.recyclerViewCalcDonate);
        searchView = findViewById(R.id.searchCalcDonate);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot data : snapshot.getChildren()) {
                            ...
                            if (material != null && "Calculators".equals(material.getCategory()) && "Available".equals(material.getStatus())) {
                                list.add(material);
                            }
                        }
                        filter(""); 
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(BuyerCalculculatorDonate.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
