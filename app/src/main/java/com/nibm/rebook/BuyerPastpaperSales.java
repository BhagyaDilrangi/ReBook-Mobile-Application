...
public class BuyerPastpaperSales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recyclerViewPastPaperSales);
        searchView = findViewById(R.id.searchPastPaperSales);
    ...
    private void fetchData() {
        // Query materials with type "Sale" and category "Past Papers"
        mDatabase.orderByChild("type").equalTo("Sale")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(BuyerPastpaperSales.this, "Error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
